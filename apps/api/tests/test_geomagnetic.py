...
from app.services import geomagnetic as service
from app.routers.public import geomagnetic as routes
from app.commands import collect_geomagnetic as command
...
def test_api_rejects_invalid_ranges_before_querying(monkeypatch):
    ...
    with TestClient(app) as client:
        prefix = '/public/observations/geomagnetic/history?'
