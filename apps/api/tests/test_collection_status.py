...
from app.db.models import ObservationSourceStatus
from app.services import collection_status as service
from app.routers.public import collection_status as routes
...
def test_api_returns_all_sources_in_empty_storage_without_fetching(monkeypatch):
    ...
    with TestClient(app) as client:
        response = client.get('/public/observations/status')
