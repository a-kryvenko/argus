...
from app.db.models import SolarWindAggregate, SolarWindAggregatePending
from app.services.solar_wind import METADATA, metadata
from app.services.solar_wind_aggregation import VERSION
