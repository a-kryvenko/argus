...
from app.db.models import SolarWindObservation, SolarWindAggregate, SolarWindAggregatePending, SolarWindRetiredHour
from app.db.session import get_database_url
from app.services import solar_wind_retention as retention, solar_wind_aggregation as aggregation
...
async def main():
    ...
    def migrate(conn, suffix, operation):
        file = next((root/'apps/api/alembic/versions').glob(f'*_{suffix}.py'))
