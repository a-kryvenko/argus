"""Migrations are scoped to prophet; runtime and migrations share one database owner."""
...
if context.is_offline_mode():
    ...
    with context.begin_transaction():
        context.execute('CREATE SCHEMA IF NOT EXISTS prophet')
    ...
    with engine.connect() as connection:
        ...
        connection.execute(text('CREATE SCHEMA IF NOT EXISTS prophet'))
        connection.commit()
