...
from app.db.models import SolarWindObservation, SolarWindAggregate, SolarWindAggregatePending
from app.services import solar_wind_aggregation as service
...
async def main():
    ...
    spec = importlib.util.spec_from_file_location('migration', root/'apps/api/alembic/versions/20260908_0007_solar_wind_aggregates.py')
    ...
    try:
        ...
        async with db.begin() as conn:
            ...
            upgrade_spec = importlib.util.spec_from_file_location('closed_migration', root/'apps/api/alembic/versions/20260908_0008_closed_aggregate_windows.py')
