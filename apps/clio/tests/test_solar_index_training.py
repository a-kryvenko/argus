...
from forecast_core.data_pipelines.solar_index_training import (
...
def _run_notebook(name: str) -> dict:
    directory = NOTEBOOKS.parent / "apps/clio/notebooks" if name.startswith("0_") else NOTEBOOKS
    notebook = json.loads((directory / name).read_text())
